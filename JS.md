...
alert("HTML: 😁, CSS: 😃, JS: 💀💀")
alert("created by Parrot (me) and my neighbor friend (Albert) | creator: Sudhakar")
alert("upvote it, hope you enjoy (u cant win >:) -albert said)")
alert("here's the original: https://sololearn.com/compiler-playground/WYd6M8hmGWp9/?ref=app")
    ...
    function updateSquarecolor(){
        for(var n = 0; n < 64; n++){
            if(Math.floor(n/8)%2 === 0){
                if(n%2 === 0){
                    sqs[n].style.background = '#CD853F';
                }
                else {
                    sqs[n].style.background = '#F5DEB3';
                }
            }
            else {
                if(n%2 === 1){
    ...
    function check(){
        if(myTurn){
                        ...
                        if("prnbkq".indexOf(checkArr[y]) >= 0){
                            ...
                            for(var z = 0; z < checkScp.length; z++){
                                if(checkArr[checkScp[z]] === 'l'){
                                    if(!saveKing){
                                        alert('Save your KING or else >:), Ill k!ll him >:D');
                                        saveKing = true;
                                    }
                                }
                            }
            ...
            for(var x = 0; x < scopes.length; x++){
                sqs[scopes[x]].style.background = 
"mediumspringgreen";//.classList.add("scope");
            //    alert(scopes)
            }
        }
    }
    ...
    //    alert(effects)
        ...
        if(bestMove){
            ...
            sqs[bestMove.split("-")[1]].style.background = '#20B2AA';
            sqs[bestMove.split("-")[0]].style.background = '#20B2AA';
